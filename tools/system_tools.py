...
def register_system_tools(mcp: FastMCP):
    ...
    def get_data_summary() -> str:
        ...
        summary = {
            ...
            "market": {
                "current_market_type": data_manager.market.get("market_overview", {}).get("market_type"),
                "avg_days_on_market": data_manager.market.get("market_overview", {}).get("avg_days_on_market")
            }
        }
